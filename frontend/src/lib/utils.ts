...
export const DEMO_POLICIES = [
  {
    ...
    description: 'Enterprise procurement with vendor verification and finance approval',
    icon: '🏢',
  },
  {
    key: 'refund',
  ...
  },
  {
    ...
    policy: 'Verify employee identity, obtain manager approval, then provision system access.',
    description: 'Employee access provisioning with identity verification',
    icon: '🔐',
  },
];
